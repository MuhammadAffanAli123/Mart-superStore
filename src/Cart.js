               ...
               
                {
                    (value)=>{
                       ...
                       <div  className="col-10 col-lg-2">
                                ...
                                }} style={{background:"gray", color:"white"}}>+</button><span style={{fontSize:"200%",marginTop:"70%"}}>{item.count}</span>
                       
                       <button onClick={()=>{
                                    console.log(value.cartcaldecrem(item.id), console.log(value.gtotal()))
                                }}  style={{background:"gray", color:"white"}}>-</button>
                    ...
                    <div className="row text-right" style={{border:"2px solid" ,backgroundColor:"black"}}>
