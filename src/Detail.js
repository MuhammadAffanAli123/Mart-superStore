            ...
            <div>
                <ProductConsumer>
                {
                    ...
                    (value)=>{
                        ...
                        <h3  className=" col-xl-12 col-md-12 col-sm-12 col-md-12 text-center" style={{backgroundColor:"black",color:"white",fontFamily: "Oswald, sans-serif"}}>{title}</h3></div>

                           <div className="row text-center"style={{marginTop:"4%"}}  >
                               
                       <div className="col-12 text-center">
                        <p  style={{fontSize:"30px",color:"black",fontFamily: "Oswald, sans-serif"}}>{title}</p>
                        </div>
                                        </div>
                     ...
                     <Link to="/" style={{marginLeft:"0%"}}>
                                 <Button style={{backgroundColor:"black", border:"2px solid black"}} >BACK</Button></Link>
                             
                            
                             
                    <Button style={{marginLeft:"1%" , backgroundColor:"gray", border:"2px solid gray"}} variant="success"  disabled={incart?true:false}  onClick={()=>{value.modal(id)
